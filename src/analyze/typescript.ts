    ...
    for (const file of processed) {
        ...
        if (!sourceFile)
            throw new Error(
                `File ${
                    file.srcFile
                } not found. If you're importing an NPM package, make sure the package has been installed by running "yarn add <package name>". Alternatively, make sure you've run "yarn install".`,
            )
